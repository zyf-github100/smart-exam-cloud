ALTER TABLE admin_db.sys_audit_log
    ADD COLUMN IF NOT EXISTS service_name VARCHAR(64) NOT NULL DEFAULT 'unknown-service' AFTER id,
    ADD COLUMN IF NOT EXISTS module_key VARCHAR(64) NOT NULL DEFAULT 'GENERAL' AFTER service_name;
